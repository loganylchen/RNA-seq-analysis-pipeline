rule get_genome:
    ...
    script:
        "../../scripts/preprocessing/get_ensembl_sequence.sh"
...
rule get_annotation:
    ...
    script:
        "../../scripts/preprocessing/get_ensembl_annotation.sh"
...
rule geneid_to_genename:
    ...
    resources:
        mem_mb=config["resources"]["mem_mb"].get("default", 4096),
    script:
        "../../scripts/preprocessing/get_genename.py"
...
rule gtf_to_bed:
    ...
    resources:
        mem_mb=config["resources"]["mem_mb"].get("default", 4096),
    script:
        "../../scripts/preprocessing/gtf2bed.sh"
...
rule gtf_to_refflat:
    ...
    resources:
        mem_mb=config["resources"]["mem_mb"].get("default", 4096),
    script:
        "../../scripts/preprocessing/gtf2refflat.py"
